...
const DeeniTubeDetail = () => {
  ...
  return (
    <>
          ...
          <div className={styles.inner}>
            <div className={classNames(styles.detail_text, styles.app_card)}>
              <div className={styles.app_card_inner}>
                <p>
                    An authentic Islamic video platform featuring content from renowned scholars, available in multiple languages to cater to diverse audiences.
      ...
      {/*        <h2><span className={aboutStyles.highlight}>DeeniTube</span> Apps</h2>*/}
      ...
      {/*                        <a href="https://www.deeni.tube" target="_blank"><span style={{ color: `#1377FD` }}> www.Denni.tube</span></a>,*/}
...
export default DeeniTubeDetail;
