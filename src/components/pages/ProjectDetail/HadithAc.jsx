...
const HadithAcDetail = () => {
  ...
  return (
    <>
          ...
          <div className={styles.inner}>
            <div className={classNames(styles.detail_text, styles.app_card)}>
              <div className={styles.app_card_inner}>
                <p>
                    Hadith application. Some of the features are Hadith books & categories, Reader friendly UI, Custom settings, Bookmarks, User login access.
      ...
      {/*                /!* <span style={{ color: `#1377FD` }}>https://play.google.com/store/apps/details?id=com.deeniinfotech.hadith.ac</span> *!/*/}
      {/*              </a>*/}
      {/*            </div>*/}
      {/*          </div>*/}
      {/*        </div>*/}
      ...
      {/*                        <a href="https://www.hadith.ac" target="_blank"><span style={{ color: `#1377FD` }}> www.Hadith.ac</span></a>,*/}
      ...
      {/*                        /!* <span style={{ color: `#1377FD` }}>www.Hadith.ac</span> *!/*/}
      {/*                    </a>*/}
      {/*                </div>*/}
      {/*            </div>*/}
      {/*        </div>*/}
