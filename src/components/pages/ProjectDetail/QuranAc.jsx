...
const QuranAcDetail = () => {
  ...
  return (
    <>
          ...
          <div className={styles.inner}>
            <div className={classNames(styles.detail_text, styles.app_card)}>
              <div className={styles.app_card_inner}>
                <p>
                    Quran application. Some of the features are Multi translations, Reader friendly UI, Custom settings, Bookmarks, User login access.
                    This app is scheduled to launch by 2025, In'Sha Allah.
                </p>
              </div>
            </div>
          </div>
      ...
      {/*        <h2><span className={aboutStyles.highlight}>quran.ac</span> Apps</h2>*/}
      ...
      {/*                /!* <span style={{ color: `#1377FD` }}>https://play.google.com/store/apps/details?id=com.deeniinfotech.quran.ac</span> *!/*/}
      {/*              </a>*/}
      {/*            </div>*/}
      {/*          </div>*/}
      {/*        </div>*/}
      ...
      {/*                        <a href="https://www.quran.ac" target="_blank"><span style={{ color: `#1377FD` }}> www.Quran.ac</span></a>,*/}
      ...
      {/*                        /!* <span style={{ color: `#1377FD` }}>www.Quran.ac</span> *!/*/}
      {/*                    </a>*/}
      {/*                </div>*/}
      {/*            </div>*/}
      {/*        </div>*/}
